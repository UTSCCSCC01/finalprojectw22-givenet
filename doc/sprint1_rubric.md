...
## Notes:
- All commit messages should begin with the ticket number rather than just the description
- PRs should be made by the person to whom the task has been assigned to
- Missing PR for some user stories (i.e. GIV-29)